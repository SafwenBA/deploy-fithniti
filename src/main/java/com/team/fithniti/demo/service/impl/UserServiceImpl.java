...
//        if (!user.isPresent()) throw new ResourceNotFound("NOT_FOUND","Wrong phoneNumber !");
...
//        if (!registrationRequest.isPresent()) throw new ResourceNotFound("NOT_FOUND","Request was not found !") ;
